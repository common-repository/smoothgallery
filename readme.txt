...
* Added a translation for the Ukrainian language (thanks to <a rel="nofollow" href="http://getvoip.com">GetVoIP</a>)
...
* Bugfix in the <code>config.php</code> (thanks to <a rel="nofollow" href="http://davideferrero.com">Davide</a>).
...
* Added a translation for the Romanian language (thanks to <a rel="nofollow" href="http://webhostinggeeks.com/">Web Hosting Geeks</a>)

= 1.15.3 =

* Fixed minor bug that could occur when one used the <code>id</code> attribute in the shortcode which pulled images from a certain post and extracted the special <em>SmoothGallery link</em> that one might add to images.
* Removed empty lines at the end of most PHP files which might cause issues resulting in <em>Header already sent</em> messages.
...
* It's possible to order the images now (thanks to <a rel="nofollow" href="http://liebrand.co.uk/">Jelte Liebrand</a>)
